...
import { ZiinaCheckoutPage, ZiinaProviderConnect } from './ZiinaPages'
...
export default function AppRouter() {
  ...
  if (path === '/provider/ziina') return <ZiinaProviderConnect />
  if (checkoutMatch) return <ZiinaCheckoutPage bookingId={checkoutMatch[1]} />
  if (path === '/provider' || path.startsWith('/provider/')) return <><ProviderHubV2 /><a className="ziina-provider-shortcut" href="/provider/ziina">Ziina Checkout</a></>
