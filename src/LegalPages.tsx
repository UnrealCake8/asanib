...
const sections: Record<LegalKind, { title: string; intro: string; blocks: { heading: string; body: string[] }[] }> = {
  privacy: {
    ...
    blocks: [
      ...
      { heading: '4. Business verification documents', body: ['Provider trade-licence and Emirates ID verification files are stored in private object storage and are not published to customers or other providers. Access is limited to the provider for upload and authorised Asanib administrators for verification, fraud prevention and support purposes. Administrative access uses short-lived secure links rather than public document URLs.', 'Emirates ID documents are collected for provider identity and authority verification. They should not be uploaded anywhere else in Asanib. We may retain verification records for account integrity, dispute handling, fraud prevention and legal or operational recordkeeping, and we will limit retention where those records are no longer reasonably required.'] },
      { heading: '5. Payments', body: ['Where Asanib Checkout is available, the payment interface is provided by Ziina and the payment is processed through the Ziina Business account of JS Ventures LLC, the operator of Asanib. Payment-card details entered into the Ziina checkout are processed by Ziina and are not stored by Asanib. Asanib may retain payment references, status, amount and related booking records so the platform can confirm whether a booking has been paid.', 'Some providers may also offer an external checkout link. If you choose that option, you leave Asanib and the destination provider or payment processor handles the payment under its own terms and privacy practices.'] },
      { heading: '6. How we use information', body: ['We use information to operate accounts, match customer requests with relevant providers, allow providers to quote, manage bookings, verify provider businesses and authorised representatives, facilitate available payment options, deliver service notifications, prevent abuse, provide support and improve the reliability of Asanib.', 'Where a provider has supplied a WhatsApp number for job alerts, Asanib may use that number to send service-related notifications from an Asanib-operated WhatsApp channel once that notification channel is enabled.'] },
      { heading: '7. Sharing', body: ['Customer request details are shared only as reasonably necessary with relevant provider accounts so they can decide whether to quote. Provider details may be shown to customers when needed to compare quotes or complete a booking. Emirates ID verification documents are not shared with customers or unrelated providers.', 'We may use infrastructure and service providers such as Firebase, Vercel, Cloudflare, Google Maps Platform and Ziina to operate the platform. They process relevant data in accordance with their own terms and our configuration.'] },
      { heading: '8. Data retention and security', body: ['We retain information for as long as reasonably necessary to operate the service, maintain records, resolve disputes and meet legal obligations. Verification documents are kept in private storage with access controls. We use reasonable technical and organisational measures to protect information, but no online system can guarantee absolute security.'] },
      { heading: '9. Your choices', body: ['You may stop using Asanib at any time. Providers can update their business profile and availability. You may contact us to request access, correction or deletion of eligible personal information, including verification information where deletion is legally and operationally permitted.'] },
  ...
  terms: {
    ...
    blocks: [
      ...
      { heading: '4. Provider responsibilities', body: ['Providers are responsible for maintaining accurate business information, qualifications, licences, insurance and permits where applicable. Providers must only submit verification documents they are authorised to provide. Quotes should clearly reflect the expected price and scope. Providers are responsible for the quality, legality and safe delivery of their services.'] },
      { heading: '5. Quotes, bookings and payment', body: ['A quote is an offer from a provider. A booking is formed when the customer accepts a quote through Asanib.', 'Where Asanib Checkout is available, Ziina provides the payment interface and JS Ventures LLC receives the customer payment into its Ziina Business account for the Asanib booking. Asanib records the payment status and reference against the booking. Any settlement or amount owed by JS Ventures LLC to the service provider is handled separately from the customer checkout flow.', 'A provider may also offer an approved external checkout destination. Customers choosing an external checkout leave Asanib and pay through the provider or its selected payment processor.'] },
      { heading: '6. Cancellations, disputes and refunds', body: ['Refund responsibility depends on the payment method and the circumstances of the service. Where a payment was made through Asanib Checkout, JS Ventures LLC may process an eligible refund or reversal through Ziina where available, subject to the booking circumstances, provider position, applicable law and payment-processor rules. Where payment was made directly to a provider, the provider is normally responsible for any refund due.', 'Asanib may assist with platform records or communications, but this does not guarantee a particular dispute outcome.'] },
  ...
  refunds: {
    ...
    blocks: [
      { heading: '1. Payment methods', body: ['Customers may pay using Asanib Checkout powered by Ziina where available, an approved external provider checkout, or another payment method agreed directly with the provider.'] },
      { heading: '2. Refunds for provider service payments', body: ['The provider remains responsible for the underlying service. If the customer paid through Asanib Checkout, JS Ventures LLC received that payment through its Ziina Business account and may process an eligible refund or reversal where appropriate and supported by Ziina. If the customer paid the provider directly, the provider is normally responsible for any refund due.'] },
      { heading: '3. Cancelling an Asanib request', body: ['An open request may be cancelled in the app before a quote is accepted. Once cancelled, pending provider quotes are closed and matched providers may see that the customer cancelled the request. Once a quote has been accepted and a booking created, cancellation may affect the provider’s time or costs and should be handled promptly with the provider.'] },
      { heading: '4. Asanib Checkout', body: ['Where a customer pays through Asanib Checkout, the payment interface is provided by Ziina and the payment is received into the Ziina Business account of JS Ventures LLC. Provider settlement is handled separately from the customer payment flow. Refunds or reversals may depend on the booking circumstances, provider position, Ziina’s available payment features and applicable law.'] },
